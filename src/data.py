...
FIELD_ALIASES = {
    ...
    "lead_time_days": ["lead_time", "lead time", "lead_time_days", "lead days", "days", "delivery_time", "transit_days", "delivery_days", "days_in_transit", "shipping_days", "fulfillment_days"],
    "ship_mode": ["ship mode", "ship_mode", "shipping mode", "mode", "vehicle", "service_level", "service_type", "carrier_service", "transport_mode", "mode_of_transport"],
    "country_region": ["country/region", "country region", "country", "destination_country"],
    "city": ["city", "destination city", "destination"],
    "state": ["state/province", "state province", "state", "province", "destination_state", "delivery_state", "consignee_state", "recipient_state"],
    "region": ["region", "zone", "corridor", "delivery_zone", "shipping_zone", "distribution_zone", "territory"],
    "product_name": ["product name", "product_name", "product", "item", "sku_name"],
    "sales": ["sales", "revenue", "amount", "order_value", "shipment_value", "invoice_amount", "billed_amount"],
    "units": ["units", "quantity", "qty", "volume", "quantity_shipped", "item_count", "piece_count", "num_units"],
    "gross_profit": ["gross profit", "gross_profit", "profit", "margin_value"],
    "cost": ["cost", "shipping_cost", "expense", "freight_cost", "shipping_fee", "carrier_cost", "transport_cost", "handling_cost"],
    "factory": ["factory", "warehouse", "warehouse or factory", "origin", "origin_factory", "dispatch_center", "fulfillment_center", "warehouse_code", "sender"],
